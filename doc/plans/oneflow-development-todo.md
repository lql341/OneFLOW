...
- [ ] **P2.3：减少每个 RK stage 的 H2D/D2H**
  - [x] 第一刀：`13275297` 让 HIP batch 直接从 MRField 方程分量上传/回传，移除连续 face/residual host pack/unpack；同 basis 端到端 HIP 从 `1.034361x` 提升到 `1.153677x`。
